        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Badge variant="outline" className="text-xs border-blue-500/30 text-blue-400 bg-blue-500/5">
              <Sparkles className="h-3 w-3 mr-1" /> Trader Overview
            </Badge>
          </div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Manage your daily work zone, review customer bookings, and monitor Stripe Connect payout status.
          </p>
        </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-baseline gap-2">
                ...
                <Badge variant="outline" className="text-[10px] border-emerald-500/30 text-emerald-400 bg-emerald-500/10">
                  <TrendingUp className="h-2.5 w-2.5 mr-1" /> 2 Confirmed
                </Badge>
              </div>
        ...
        <Card className="border-border/50 bg-card/60 backdrop-blur-sm hover:border-primary/40 transition-all shadow-sm">
          <CardContent className="p-4 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-bold text-foreground">15 Miles</span>
              </div>
              <p className="text-[11px] text-emerald-400 font-medium flex items-center gap-1">
                <CheckCircle2 className="h-3 w-3" /> Coverage set (SW1A 1AA)
              </p>
            </div>
