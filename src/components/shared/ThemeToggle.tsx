...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="relative h-9 w-9 rounded-lg border border-border/40 bg-background/50  transition-all duration-200 focus-visible:ring-1 focus-visible:ring-ring cursor-pointer"
